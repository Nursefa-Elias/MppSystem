      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li id="dashboardMainMenu">
          <a href="<?php echo base_url('dashboard') ?>">
            <i class="fa fa-dashboard"></i> <span>Mpp-HOME</span>
          </a>
        </li>
        ...
        <?php if($user_permission): ?>
         ...
         <!--   <li id="Mpp">
          <a href="<?php echo base_url('orders/creatempp') ?>">
            <i class="fa fa-dashboard"></i> <span>Mekdes Printing press order</span>
          </a>
        </li> -->
          ...
          <?php if(in_array('createOrder', $user_permission) || in_array('updateOrder', $user_permission) || in_array('viewOrder', $user_permission) || in_array('deleteOrder', $user_permission)): ?>
            <li class="treeview" id="mainOrdersNav">
              ...
              <ul class="treeview-menu">
                ...
                <li id="manageOrdersNav"><a href="<?php echo base_url('orders') ?>"><i class="fa fa-circle-o"></i> Report & Manage-Orders</a></li>
                <?php endif; ?>
              </ul>
            </li>
          <?php endif; ?>
        ...
        <!-- Employee evaluation page, based on Behaviour and work Strength-->

        <?php if(in_array('createProduct', $user_permission)); ?> 
          <li><a herf="<?php echo base_url('products/create') ?>"><i class="fa fa-circle-o"></i> <span>Employee-Evaluation</span></a></li>
        <?php endif; ?>        
